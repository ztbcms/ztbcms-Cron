...
class CronModel extends Model {
	...
	protected $_validate = array(
		...
		array('subject', 'require', '计划任务名称不能为空！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
		array('loop_type', 'require', '计划任务类型不能为空！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
		array('cron_file', 'require', '计划任务执行文件不能为空！', self::MUST_VALIDATE, 'regex', self::MODEL_BOTH),
	);
	//自动完成
